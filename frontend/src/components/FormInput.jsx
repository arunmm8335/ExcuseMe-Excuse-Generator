    ...
    <div className="form-control">
      ...
      <div className="relative">
        ...
        <input
          ...
          value={value}
          className={`input input-bordered w-full bg-base-200/50 border-base-300/50 focus:border-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-primary transition-colors ${Icon ? 'pl-10' : 'pl-4'} rounded-xl`}
          required={required}
          onChange={onChange}
          aria-label={label}
          tabIndex={tabIndex}
